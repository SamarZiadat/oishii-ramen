...
urlpatterns = [
    ...
    path('book',
         login_required(views.CourseBook.as_view()), name='course_book'),
    path('bookings', login_required(views.CourseMyBookings.as_view()),
         name='course_mybookings'),
    path('course/add/', views.CourseAdd.as_view(), name='course_add'),
    path('<slug:slug>/edit/',
         login_required(views.CourseEdit.as_view()), name='course_edit'),
]
